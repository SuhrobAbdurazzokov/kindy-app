...
export class ChildAttendanceController {
  constructor(private readonly childAttendanceService: ChildAttendanceService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateChildAttendanceDto: UpdateChildAttendanceDto) {
